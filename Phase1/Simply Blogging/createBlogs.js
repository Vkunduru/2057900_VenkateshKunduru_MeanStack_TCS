function addBlog(){
  ...
  blogpost2.style.backgroundColor= "teal";
  blogpost2.style.color= "white";
  blogpost2.style.borderRadius = 10 + "px";
  blogpost2.style.margin = 15+"px";
  blogpost2.style.width = 400+"px";
  blogpost2.style.height = 400+"px";
